    ...
    <div class="product__item">
        <div class="product__item__pic set-bg" data-setbg="{{ $image ?? asset('assets/img/product/product-1.jpg') }}">
            ...
            <ul class="product__hover">
                <li>
                    <a href="{{ $image ?? asset('assets/img/product/product-1.jpg') }}" class="image-popup"><span class="arrow_expand"></span></a>
                </li>
                <li>
        ...
        <div class="product__item__text">
            <h6><a href="#">{{ $title ?? 'Buttons tweed blazer' }}</a></h6>
            <div class="rating">
                @php
                $rating = $rating ?? 0;
                @endphp
            ...
            <div class="product__price">{{ $price ?? '$ 0.0' }}</div>
        </div>
    </div>
</div>