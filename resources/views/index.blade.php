          ...
          <div class="product__item">
            <div
              ...
              <ul class="product__hover">
                <li>
                  <a href="{{ asset('assets/img/product/product-1.jpg') }}" class="image-popup"><span class="arrow_expand"></span></a>
                </li>
                <li>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 mix men">
          <div class="product__item">
            <div
              ...
              <ul class="product__hover">
                <li>
                  <a href="{{ asset('assets/img/product/product-2.jpg') }}" class="image-popup"><span class="arrow_expand"></span></a>
                </li>
                <li>
                  <a href="#"><span class="icon_heart_alt"></span></a>
                </li>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 mix accessories">
          <div class="product__item">
            <div
              ...
              <ul class="product__hover">
                <li>
                  <a href="{{ asset('assets/img/product/product-3.jpg') }}" class="image-popup"><span class="arrow_expand"></span></a>
                </li>
                <li>
                  <a href="#"><span class="icon_heart_alt"></span></a>
                </li>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 mix cosmetic">
          <div class="product__item">
            <div
              ...
              <ul class="product__hover">
                <li>
                  <a href="{{ asset('assets/img/product/product-4.jpg') }}" class="image-popup"><span class="arrow_expand"></span></a>
                </li>
                <li>
                  <a href="#"><span class="icon_heart_alt"></span></a>
                </li>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 mix kid">
          <div class="product__item">
            <div
              ...
              <ul class="product__hover">
                <li>
                  <a href="{{ asset('assets/img/product/product-5.jpg') }}" class="image-popup"><span class="arrow_expand"></span></a>
                </li>
                <li>
                  <a href="#"><span class="icon_heart_alt"></span></a>
                </li>
        ...
        <div
          ...
          <div class="product__item sale">
            <div
              ...
              <ul class="product__hover">
                <li>
                  <a href="{{ asset('assets/img/product/product-6.jpg') }}" class="image-popup"><span class="arrow_expand"></span></a>
                </li>
                <li>
                  <a href="#"><span class="icon_heart_alt"></span></a>
                </li>
        ...
        <div
          ...
          <div class="product__item">
            <div
              ...
              <ul class="product__hover">
                <li>
                  <a href="{{ asset('assets/img/product/product-7.jpg') }}" class="image-popup"><span class="arrow_expand"></span></a>
                </li>
                <li>
                  <a href="#"><span class="icon_heart_alt"></span></a>
                </li>
        ...
        <div
          ...
          <div class="product__item sale">
            <div
              ...
              <ul class="product__hover">
                <li>
                  <a href="{{ asset('assets/img/product/product-8.jpg') }}" class="image-popup"><span class="arrow_expand"></span></a>
                </li>
                <li>
                  <a href="#"><span class="icon_heart_alt"></span></a>
                </li>
      ...
      <div class="row">
        <div class="p-0 col-lg-2 col-md-4 col-sm-4">
          <div
            ...
            data-setbg="{{ asset('assets/img/instagram/insta-1.jpg') }}">
        ...
        <div class="p-0 col-lg-2 col-md-4 col-sm-4">
          <div
            class="instagram__item set-bg"
            data-setbg="{{ asset('assets/img/instagram/insta-2.jpg') }}">
            <div class="instagram__text">
              <i class="fa fa-instagram"></i>
              <a href="#">@ Trenz_shop</a>
            </div>
        ...
        <div class="p-0 col-lg-2 col-md-4 col-sm-4">
          <div
            class="instagram__item set-bg"
            data-setbg="{{ asset('assets/img/instagram/insta-3.jpg') }}">
            <div class="instagram__text">
              <i class="fa fa-instagram"></i>
              <a href="#">@ Trenz_shop</a>
            </div>
        ...
        <div class="p-0 col-lg-2 col-md-4 col-sm-4">
          <div
            class="instagram__item set-bg"
            data-setbg="{{ asset('assets/img/instagram/insta-4.jpg') }}">
            <div class="instagram__text">
              <i class="fa fa-instagram"></i>
              <a href="#">@ Trenz_shop</a>
            </div>
        ...
        <div class="p-0 col-lg-2 col-md-4 col-sm-4">
          <div
            class="instagram__item set-bg"
            data-setbg="{{ asset('assets/img/instagram/insta-5.jpg') }}">
            <div class="instagram__text">
              <i class="fa fa-instagram"></i>
              <a href="#">@ Trenz_shop</a>
            </div>
        ...
        <div class="p-0 col-lg-2 col-md-4 col-sm-4">
          <div
            class="instagram__item set-bg"
            data-setbg="{{ asset('assets/img/instagram/insta-6.jpg') }}">
            <div class="instagram__text">
              <i class="fa fa-instagram"></i>
              <a href="#">@ Trenz_shop</a>
            </div>
