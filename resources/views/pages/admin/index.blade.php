                            ...
                            <div class="card-body">
                                ...
                                <div class="py-4 card-list">
                                    ...
                                    <div class="item-list">
                                        <div class="avatar">
                                            <span
                                                class="border border-white avatar-title rounded-circle">CF</span>
                                        </div>
                                        <div class="info-user ms-3">
                                    ...
                                    <div class="item-list">
                                        <div class="avatar">
                                            <span
                                                class="border border-white avatar-title rounded-circle bg-primary">H</span>
                                        </div>
                                        <div class="info-user ms-3">
                                    ...
                                    <div class="item-list">
                                        <div class="avatar">
                                            <span
                                                class="border border-white avatar-title rounded-circle bg-secondary">F</span>
                                        </div>
                                        <div class="info-user ms-3">
